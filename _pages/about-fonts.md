...
sitemap: true
---
<i class="fa-sharp fa-regular fa-file-pen"></i> *마지막 수정: 2025. 9. 21.*
...
# 본고딕 설치
본고딕은 한자문화권 글꼴로서는 장점이 많은 글꼴이지만, 다운로드 및 설치하는 것이 복잡하다는 단점이 있습니다.
...
그래서 하나조노의 대체품으로 최신 유니코드(17.0 기준)의 한자까지 지원하는 [Jigmo](https://kamichikoichi.github.io/jigmo/)라는 글꼴이 나왔습니다(최근 업데이트: 2025. 9. 12.).
...
하나조노의 고딕체판 글꼴 정도로 보시면 됩니다(~유니코드 17.0).
